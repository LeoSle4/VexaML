...
def main():
    ...
    pre_ci = bootstrap_ci(lambda a,b: precision_score(a,b,zero_division=0), y_te.values, pred)
    ...
    Path("reports/metrics_test.json").write_text(json.dumps(report, indent=2), encoding="utf-8")
